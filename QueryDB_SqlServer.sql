...
USE master
GO
DROP DATABASE IF EXISTS DB_TRABAJO_01
GO

CREATE DATABASE DB_TRABAJO_01;
GO
...
('Floreria Rosaflor S.A.C.','20432197630','denverflowers@gmail.com','929127629','Candela Silvestre 47','ACCESORIO','I','250401');
...
(TIPPRO,NOMPRO,PREPRO,DESPRO,STOCKPRO,ESTPRO,IDPROV) VALUES
...
('Flor','Lirium','6','Flor de color naranja, Cuenta la leyenda que la flor de Lilium brotó de las lágrimas de Eva','25','I','12');
...
('76919430','Doris Enzo','Quintero Rojas','931542230','Av. Cesar Vallejo','dquintero@vallegrande.edu.pe','A','C','0','150501'),
